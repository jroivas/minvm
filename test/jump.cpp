...
static void test_jump_jmp64()
{
    static uint8_t mem[] = {
        *impl::Opcode::LOAD_INT8(), 0, 1,
        *impl::Opcode::JMP64(), 0, 0, 0, 0, 0, 0, 0, 14,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::STOP()
    };
...
{
    static uint8_t mem[] = {
        *impl::Opcode::LOAD_INT8(), 0, 0,
        *impl::Opcode::LOAD_INT8(), 1, 2,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::JMP_LE8(), 1, 0, 1, (uint8_t)-6,
        *impl::Opcode::STOP()
    };
...
static void test_jump_jmp_le16()
{
    static uint8_t mem[] = {
        ...
        *impl::Opcode::LOAD_INT8(), 1, 2,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::JMP_LE16(), 1, 0, 1, 0, 0,
        *impl::Opcode::STOP()
    };
...
static void test_jump_jmp_le32()
{
    static uint8_t mem[] = {
        ...
        *impl::Opcode::LOAD_INT8(), 1, 2,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::JMP_LE32(), 1, 0, 1, 0, 0, 0, 0,
        *impl::Opcode::STOP()
    };
...
static void test_jump_jmp_le64()
{
    static uint8_t mem[] = {
        ...
        *impl::Opcode::LOAD_INT8(), 1, 2,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::JMP_LE64(), 1, 0, 1, 0, 0, 0, 0, 0, 0, 0, 6,
        *impl::Opcode::STOP()
    };
...
static void test_jump_jmp_le_int()
{
    static uint8_t mem[] = {
        *impl::Opcode::LOAD_INT8(), 0, 0,
        *impl::Opcode::LOAD_INT8(), 1, 2,
        *impl::Opcode::LOAD_INT8(), 2, 9,
        *impl::Opcode::INC_INT(), 0,
        *impl::Opcode::JMP_LE_INT(), 1, 0, 1, 2,
        *impl::Opcode::STOP()
    };
